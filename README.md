...
📍 인터랙티브 UI 개발
• 모바일 앱과 유사한 레이아웃 설계
• CSS 애니메이션 사용 시 성능 문제를 최소화하고자 transform 속성 활용

📍 페이지 전환 효과
• 사용자 탐색 경험이 자연스러워지도록 모바일 앱처럼 부드러운 페이지 전환
• 모든 페이지 전환 시 애니메이션 효과와 함께 컴포넌트가 마운트 되도록 구현

📍 상호 작용성 강화
• 이미지 정렬과 캐로셀 컨트롤을 위해 직관적인 드래그 인터랙션 구현 
• 모달 팝업을 적극적으로 활용하여 즉각적인 행동을 유도
• 모든 모달 팝업은 슬라이드 오픈 방식으로 동적 인터페이스 구현

📍 사용자 경험 향상
• 동적인 UI 요소 개발
• 요소에 호버 시 정보가 표시되는 피드백 제공
• 각 페이지에 뒤로 가기 버튼을 배치하여 웹에서 앱과 유사한 탐색 경험 제공
...
<details>
  ...
  <ol>
    ...
    </li><img width="1188" alt="스크린샷 2024-03-01 오후 3 08 59" src="https://github.com/KIMYOUNGWOON/TRENDIK/assets/126956430/e8c10a26-1ae1-4aca-8204-d9c9df76020c">
  </ol>
</details>
